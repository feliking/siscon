...
<body>
  <nav class="cd-stretchy-nav">
    ...
    <div class="wrapper">
      ...
      <form name="crea_limpieza" class="form-wrapper" method="post" action="../controller/add_limpieza.php" enctype="multipart/form-data">
        <fieldset class="section is-active">
          ...
          <input type="number" name="canon_mensual" id="canon_mensual" placeholder="Introduzca monto Ej. 2056.90" step="0.01">
          <br>
