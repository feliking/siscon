...
<body>
    <nav class="cd-stretchy-nav">
        ...
        <ul>
            ...
            <li><a href="../views/add_monitoreo.php"><span><font color="red">Añadir contratos de monitoreo</font></span></a></li>
  ...
  <table id="example" class="display table table-fixed table-bordered table-hover nowrap compact" cellspacing="0" width="100%">
                    ...
                    if ($arreglo[5]<$nuevo2 && $arreglo[5]>date("Y-m-d")) {
                            if ($arreglo[13]!=1) {
                                ...
                                try {
                                    ...
                                    $mail->Body    = "Promujer informa que el contrato de $arreglo[3] por el concepto de monitoreo de alarmas le queda aproximadamente un mes para su conclusion, Que tenga una excelente jornada";
                                    $mail->send();
                                    $sql1= "UPDATE monitoreo set noti2=1 where id_moni=$arreglo[0]";
                                    $query1 = $con->query($sql1);
                                    echo "<script>alert(\"Se envio un correo electronico de notificacion a $arreglo[3]\");window.location='../views/monitoreo.php';</script>";
                                } catch (Exception $e) {
                                ...
                                try {
                                    ...
                                    $mail->isHTML(true);
                                    $mail->Subject = "Notificacion de conclusion de contrato";
                                    $mail->Body    = "Promujer informa que el contrato de $arreglo[3] por el concepto de monitoreo de alarmas le queda aproximadamente dos meses para su conclusion, Que tenga una excelente jornada";
                                    $mail->send();
                        ...
                        if ($arreglo[5]<$nuevo3 && $arreglo[5]<date("Y-m-d")) {
                            if ($arreglo[15]!=1) {
                                ...
                                try {
                                    ...
                                    $mail->isHTML(true);
                                    $mail->Subject = "Notificacion de conclusion de contrato";
                                    $mail->Body    = "Promujer informa que el contrato de $arreglo[3] por el concepto de monitoreo de alarmas tiene una semana de vencido, Que tenga una excelente jornada";
                                    $mail->send();
                            ...
                            $mail = new PHPMailer(true);                              
                                try {
                                    ...
                                    $mail->isHTML(true);
                                    $mail->Subject = "Notificacion de conclusion de contrato";
                                    $mail->Body    = "Promujer informa que el contrato de $arreglo[3] por el concepto de monitoreo de alarmas acaba de vencer, Que tenga una excelente jornada";
                                    $mail->send();
     ...
     <table class="display table table-bordered table-hover nowrap compact" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php 
                        if ($_SESSION["user_id"]==0) {
                            $sql2=("SELECT region,sum(cobro) from monitoreo group by region");
                        }
                        else{
                            $sql2=("SELECT region,sum(cobro) from monitoreo where region=\"$_SESSION[regional]\"");
                        }
