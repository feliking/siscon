...
<body>
    <nav class="cd-stretchy-nav">
        ...
        <ul>
            ...
            <li><a href="../views/add_alquiler.php"><span><font color="red">Añadir contratos de alquiler</font></span></a></li>
        ...
        <?php
                    ...
                    if ($arreglo[6]<$nuevo2 && $arreglo[6]>date("Y-m-d")) {
                            if ($arreglo[17]!=1) {
                                ...
                                try {
                                    ...
                                    $mail->Body    = "Promujer informa que su contrato de alquiler del Centro Focal: $arreglo[2] le queda aproximadamente 1 mes para su conclusion, se sugiere una renovacion, Que tenga una exelente jornada";
                                    $mail->send();
                                    $sql1= "UPDATE alquiler set noti2=1 where id_alqui=$arreglo[0]";
                                    $query1 = $con->query($sql1);
                                    echo "<script>alert(\"Se envio un correo electronico de notificacion a $arreglo[4]\");window.location='../views/alquileres.php';</script>";
                                } catch (Exception $e) {
                                ...
                                try {
                                    ...
                                    $mail->isHTML(true);
                                    $mail->Subject = "Notificacion de conclusion de contrato";
                                    $mail->Body    = "Promujer informa que su contrato de alquiler del Centro Focal: $arreglo[2] le queda aproximadamente 2 mes para su conclusion, se sugiere una renovacion, Que tenga una excelente jornada";
                                    $mail->send();
                        ...
                        if ($arreglo[6]<$nuevo3 && $arreglo[6]<date("Y-m-d")) {
                            if ($arreglo[19]!=1) {
                                ...
                                try {
                                    ...
                                    $mail->isHTML(true);
                                    $mail->Subject = "Notificacion de conclusion de contrato";
                                    $mail->Body    = "Promujer informa que su contrato de alquiler del Centro Focal: $arreglo[2] lleva mas de una semana vencida, se sugiere una renovacion, Que tenga una excelente jornada";
                                    $mail->send();
                            ...
                            $mail = new PHPMailer(true);                              
                                try {
                                    ...
                                    $mail->isHTML(true);
                                    $mail->Subject = "Notificacion de conclusion de contrato";
                                    $mail->Body    = "Promujer informa que su contrato de alquiler del Centro Focal: $arreglo[2] acaba de vencer, se sugiere una renovacion, Que tenga una excelente jornada";
                                    $mail->send();
            ...
            <table class="display table table-bordered table-hover nowrap compact" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php 
                        if ($_SESSION["user_id"]==0 || $_SESSION["regional"]=="OF. NACIONAL") {
                            $sql2=("SELECT region,sum(canon_mensualbs),sum(canon_mensualsus) from alquiler group by region");
                        }
                        else{
                            $sql2=("SELECT region,sum(canon_mensualbs),sum(canon_mensualsus) from alquiler where region=\"$_SESSION[regional]\"");
                        }
