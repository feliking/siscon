...
<body>
  <nav class="cd-stretchy-nav">
    ...
    <div class="wrapper">
      ...
      <form name="crea_seguridad" class="form-wrapper" method="post" action="../controller/update_seguridad.php" enctype="multipart/form-data">
         <?php 
          extract($_GET);
        ...
        <fieldset class="section is-active">
          ...
          <input type="text" name="nombre" id="nombre" placeholder="Nombre de la empresa" value="<?php echo $nombre_empresa; ?>" required>
          ...
          <input type="number" name="guardias" id="guardias" placeholder="Numero de guardias" value="<?php echo $nro_guardias; ?>">
          <br>
