...
<body>
  <nav class="cd-stretchy-nav">
        ...
        <ul>
            ...
            <li><a href="../views/add_seguridad.php" class="active"><span>Añadir contratos de seguridad</span></a></li>
            <li><a href="../views/seguridad.php"><span>Ver contratos de seguridad</span></a></li>
    ...
    <div class="wrapper">
      <ul class="steps">
        <li class="is-active">Crear nuevo contrato de seguridad</li>
      </ul>
      <form name="crea_seguridad" class="form-wrapper" method="post" action="../controller/add_seguridad.php" enctype="multipart/form-data">
        <fieldset class="section is-active">
          ...
          <input type="number" name="guardias" id="guardias" placeholder="Numero de guardias" required>
          <br>
          <h3>Canon mensual orig.</h3>
          <input type="number" name="canon_mensualbs" id="canon_mensualbs" placeholder="Introduzca monto en Bs" step="0.01">
          <input type="number" name="canon_mensualsus" id="canon_mensualsus" placeholder="Introduzca monto en $us" step="0.01">
          <br>
