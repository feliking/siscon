...
<body>
  <nav class="cd-stretchy-nav">
        ...
        <ul>
            ...
            <li><a href="../views/add_funcionamiento.php" class="active"><span>Añadir licencia de funcionamiento</span></a></li>
    ...
    <div class="wrapper">
      ...
      <form name="crea_funcionamiento" class="form-wrapper" method="post" action="../controller/add_funcionamiento.php" enctype="multipart/form-data">
        <fieldset class="section is-active">
          ...
          <input type="text" name="fecha_ini" id="fecha_ini" placeholder="Emision" onfocus="(this.type='date')">
          <input type="text" name="fecha_fin" id="fecha_fin" placeholder="Vencimiento" onfocus="(this.type='date')">
          <br>
          ...
          <h3>Suba el archivo de patentes</h3>
