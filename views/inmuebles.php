...
<head>
  <meta charset="UTF-8">
  <title>Impuesto inmuebles</title>
...
<body>
    <nav class="cd-stretchy-nav">
        ...
        <ul>
            ...
            <li><a href="../views/add_inmueble.php"><span><font color="red">Añadir impuesto inmueble</font></span></a></li>
    ...
    <br>
    <br>
    <h1 class="titulo"><center>IMPUESTOS INMUEBLES</center></h1>
    <br>
    <br>
    <br>
  <table id="example" class="display table table-bordered table-hover nowrap compact" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th>NUMERO DE INMUEBLES</th>
                <th>DESCRIPCION DEL INMUEBLE</th>
                <th>VALOR INICIAL</th>
                <th>PAGO DE IMPUESTOS VIGENTE</th>
                <th>GESTION</th>
                <th>ENVIO DE DOCUMENTO ESCANEADO</th>
                <th>OBSERVACIONES</th>
                <th>PAGO IMPUESTOS MUNICIPALES EN BS</th>
        ...
        <?php  
            ...
            if ($_SESSION["user_id"]==0 || $_SESSION["regional"]=="OF. NACIONAL") {
                $sql=("SELECT * FROM impuestoinmu");
            }
            else{
                $sql=("SELECT * FROM impuestoinmu where contable=\"$_SESSION[regional]\"");
            }
            ...
            while($arreglo=mysqli_fetch_array($query)){
              ...
              if ($_SESSION["user_id"]==0) {
                echo "<td><a href='../views/update_inmuebles.php?id=$arreglo[0]'>Modificar</a><a href='../controller/delete_inmuebles.php?id=$arreglo[0]'>Eliminar</a></td>";
                $sql2=("SELECT * FROM usuario where ci=\"$arreglo[12]\"");
